export const translations = {
  ar: {
    ...
    auth: {
      myAccount: 'حسابي',
      signInToSync: 'مزامنة عداداتك',
      signInDesc: 'سجّل دخولك لمزامنة عداداتك عبر أجهزتك',
      signIn: 'تسجيل الدخول',
      signUp: 'إنشاء حساب',
      ...
      resetPasswordSent: 'تم إرسال رابط إعادة التعيين إلى بريدك',
      signOut: 'تسجيل الخروج',
      signOutConfirm: 'هل تريد تسجيل الخروج؟ ستبقى عداداتك محفوظة على هذا الجهاز.',
      syncedAcrossDevices: 'مزامنة عبر أجهزتك',
      syncing: 'جارٍ المزامنة...',
      syncComplete: 'تمت المزامنة',
      syncError: 'فشلت المزامنة',
      noAccount: 'ليس لديك حساب؟',
      haveAccount: 'لديك حساب بالفعل؟',
      orContinueWithout: 'أو تابع بدون حساب',
      signInError: 'فشل تسجيل الدخول',
      signUpError: 'فشل إنشاء الحساب',
      invalidEmail: 'البريد الإلكتروني غير صالح',
      weakPassword: 'كلمة المرور يجب أن تكون ٦ أحرف على الأقل',
      emailInUse: 'البريد الإلكتروني مستخدم بالفعل',
      wrongCredentials: 'البريد الإلكتروني أو كلمة المرور غير صحيحة',
      checkEmail: 'تحقق من بريدك الإلكتروني',
      confirmEmailSent: 'تم إرسال رابط التأكيد. تحقق من بريدك لتفعيل حسابك.',
      signInToSyncShort: 'تسجيل الدخول للمزامنة',
    },
  },
  ...
  en: {
    ...
    auth: {
      ...
      signInToSync: 'Sync Your Countdowns',
      signInDesc: 'Sign in to sync your countdowns across devices',
      signIn: 'Sign In',
      signUp: 'Sign Up',
      email: 'Email',
      emailPlaceholder: 'example@email.com',
      ...
      signOut: 'Sign Out',
      signOutConfirm: 'Sign out? Your countdowns will remain on this device.',
      ...
      orContinueWithout: 'Or continue without an account',
      ...
      confirmEmailSent: 'Confirmation link sent. Check your email to activate your account.',
      signInToSyncShort: 'Sign in to sync',
    },
  },
};
